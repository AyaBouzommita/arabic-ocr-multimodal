...
for PaddleOCR. It runs PaddleOCR on every image in data/raw/ that has a
...
from ocr.paddleocr import PaddleOCREngine
...
def main():
    ...
    parser.add_argument(
        "--lang",
        default="ar",
        help="PaddleOCR language code (default: ar)",
    )
    parser.add_argument(
        "--use-gpu",
        action="store_true",
    ...
    # --- Setup ---
    print("=" * 60)
    print("  PADDLEOCR ARABIC BASELINE")
    print("=" * 60)
    ...
    print(f"\n[Engine] PaddleOCR (lang={args.lang}, gpu={args.use_gpu})")
    ...
    print("\n[DONE] PaddleOCR baseline evaluation complete.")

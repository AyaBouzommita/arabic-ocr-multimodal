"""Tests for the evaluation pipeline (US-07).

Validates the ground-truth loader, CER/WER scorer, and corpus evaluator.
"""
...
class TestCERWER:
    ...
    def test_substitution_cer(self):
        ...
        # 'ة' replaced with 'ه' — a common OCR error
...
class TestGroundTruthLoader:
    ...
    def test_loader_with_project_data(self):
        ...
        # We have 2 sample images with ground truth
        assert len(pairs) >= 1

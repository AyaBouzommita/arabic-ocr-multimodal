...
with their corresponding document images.
...
class GroundTruthLoader:
    ...
    def __init__(
        ...
        """Initialise the ground truth loader.
    ...
    def load_ground_truth(self, stem: str) -> Optional[str]:
        ...
        Returns:
            The ground-truth text string, or None if the file does not exist.
        """
    ...
    def get_unpaired_images(self) -> List[Path]:
        ...
        return [
            ...
            if self.load_ground_truth(img.stem) is None
        ]
    ...
    def summary(self) -> Dict[str, int]:
        ...
        paired = self.get_pairs()
        return {
            "total_images": len(all_images),
            "paired": len(paired),
            "unpaired": len(all_images) - len(paired),
        }
